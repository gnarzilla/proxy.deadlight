...
AUTH_SECRET="your-secret-here"        # ← CHANGE THIS TO MATCH deadlight.conf
...
PAYLOAD_1='{
  "from": "test@deadlight.boo",
  "to": "'"$YOUR_EMAIL"'",
  "subject": "Test Email from Deadlight Proxy",
  "body": "This is a test email sent via the Deadlight API. If you receive this, the email system is working!"
}'
...
PAYLOAD_2='{
  ...
  "body": "If you receive this, HMAC validation is broken!"
}'
